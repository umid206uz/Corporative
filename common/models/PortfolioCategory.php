...
class PortfolioCategory extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['title', 'title_ru', 'title_en', 'url', 'url_ru', 'url_en', 'meta_title', 'meta_title_ru', 'meta_title_en', 'meta_description', 'meta_description_ru', 'meta_description_en', 'filename', 'created_date'], 'required'],
            [['status'], 'integer'],
