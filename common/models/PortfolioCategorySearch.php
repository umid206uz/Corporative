...
/**
 * PortfolioCategorySearch represents the model behind the search form of `common\models\PortfolioCategory`.
 */
class PortfolioCategorySearch extends PortfolioCategory
{
    ...
    public function rules()
    {
        return [
            [['id', 'status'], 'integer'],
            [['title', 'title_ru', 'title_en', 'url', 'url_ru', 'url_en', 'meta_title', 'meta_title_ru', 'meta_title_en', 'meta_description', 'meta_description_ru', 'meta_description_en', 'filename', 'created_date'], 'safe'],
        ];
    }
